...
#define _DUTY_MAX 2365
#define _DUTY_NEU 1280
#define _DUTY_MIN 600

#define _SERVO_ANGLE_DIFF  150  // Replace with |D - E| degree
#define _SERVO_SPEED       123  // servo speed
...
float volt_to_distance(int a_value)
{
  // Replace line into your own equation
   ...
   return 528 + (-1183 * a_value) + (-2993 * a_value * a_value) + (11249 * a_value * a_value * a_value) + (-8963  * a_value * a_value * a_value * a_value); 
}
