...
float volt_to_distance(int a_value)
{
  // Replace next line into your own equation
    return 587 + -0.159 * a_value + -0.0117 * a_value * a_value + 3.15E-05 * a_value * a_value * a_value + -2.35E-08 * a_value * a_value * a_value * a_value;
