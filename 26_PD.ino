...
void setup() {
  ...
  dist_ema = volt_to_distance(ir_sensor_filtered(10, 0.7, 0));
...
float volt_to_distance(int a_value)
{
  ...
  //return 391 - 1.18 * a_value + 8.99E-04 * a_value * a_value;
  ...
  //return 636 + -4.93 * a_value + 0.029 * a_value * a_value + -9.31E-05 * a_value * a_value * a_value + 1.13E-07 * a_value * a_value * a_value * a_value;
}
